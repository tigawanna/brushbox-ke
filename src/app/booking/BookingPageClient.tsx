  ...
  return (
    <ResponsiveGenericToolbar links={[]}>
      <div className="w-full md:mt-10 min-h-screen h-full flex flex-col  items-center">
        <div className="w-full md:mt-10 h-full flex  flex-col items-center p-5 gap-8">
          <div className="w-full bg-primary/10 z-30 p-2 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className=" py-6 px-4 sm:px-6">
              ...
              <Link
                href="/staff"
                className="inline-block mt-4 text-sm font-medium text-primary underline underline-offset-4 hover:text-accent"
              >
                Open staff view
              </Link>
            </div>
