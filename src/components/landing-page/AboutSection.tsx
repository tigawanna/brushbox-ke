...
export function AboutSection() {
  return (
    <section id="about" className="section-padding  relative max-w-[95%] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold mt-2 mb-6">
              Nairobi&apos;s Premium Beauty Destination
            </h2>

            <p className="text-white/80 mb-4">
              Welcome to Glamour Gold Salon, where beauty meets luxury in the heart of Nairobi. Our
              team of skilled professionals is dedicated to enhancing your natural beauty through
              expert hair styling, nail care, and body treatments.
            </p>

            <p className="text-white/80 mb-6">
              Founded on the principles of excellence and personalized care, we take pride in
              offering a comprehensive range of services in a relaxing and elegant environment. Each
              client receives our undivided attention and customized treatments tailored to their
