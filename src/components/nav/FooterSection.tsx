export function FooterSection() {
  ...
  return (
    <footer className="bg-neutral/70 z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className=" mb-6 max-w-md">
              Nairobi&apos;s premier beauty salon offering exceptional hair styling, nail care,
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                { name: "Hair Styles", href: "#hairstyles" },
                { name: "About Us", href: "#about" },
                { name: "Gallery", href: "#gallery" },
                { name: "Book Appointment", href: "#booking" },
              ].map((link) => (
                <li key={link.name}>
                  <a href={link.href} className=" hover:text-salon-gold transition-colors">
                    {link.name}
                  </a>
                </li>
              ))}
            ...
            <ul className="space-y-3">
              <li className="flex gap-3 ">
                <svg
                  ...
                  className="w-5 h-5 text-salon-gold shrink-0"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
                ...
                <span>123 Elegance Avenue, Westlands, Nairobi, Kenya</span>
              </li>
              <li className="flex gap-3 ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
