export function TigawannaFooter() {
  return (
    <footer className="footer bg-neutral/70 z-10 sm:footer-horizontal justify-evenly  text-neutral-content p-10">
      <aside className="flex gap-5 justify-center  items-end">
        ...
        <h1 className="text-2xl">Tigawanna</h1>
      </aside>
      <div className="w-full flex flex-wrap items-end justify-center h-full ">
        ...
        <a
          target="_blank"
          className="flex gap-1 btn btn-link btn-neutral"
